...
//            }
            ...
            if let photoOutputVideoConnection = photoOutput.connection(with: .video),
               let coordinator = self.coordinator {
                if photoOutputVideoConnection.isVideoRotationAngleSupported(coordinator.videoRotationAngleForHorizonLevelCapture) {
                    photoOutputVideoConnection.videoRotationAngle = coordinator.videoRotationAngleForHorizonLevelCapture
                }
            }
...
fileprivate let logger = Logger(subsystem: "carson-gross.learnasl", category: "Camera")
